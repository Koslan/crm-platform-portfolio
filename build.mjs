...
const out  = tpl.replace('/*__MOCKZOHO__*/', () => mock).replace('/*__DATASET__*/null', () => data).replace('/*__EVENTPAGE__*/', () => evt).replace('/*__PAGES__*/', () => pgs).replace('/*__TEAMS__*/', () => tms).replace('/*__BOARD__*/', () => brd);
